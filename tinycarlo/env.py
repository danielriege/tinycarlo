...
class CarSimEnv(gym.Env):
    def __init__(self):
        ...
        self.observation_space = gym.spaces.Box(low=0, high=255, shape=(100, 200), dtype=np.uint8)
    ...
    def simulate_step(self, fwd_vel, steering_angle):
        ...
        ang_vel = (math.tan(steering_angle) / wheelbase) * fwd_vel
